...
var Tiny = require('./js/tinyBar');
//import Tiny = require('./js/tinyBar')
console.log(Tiny);
Tiny.defaultSettings.extendInitialBarStyle = function (barDiv, topmost) {
    barDiv.style.left = '100%';
    barDiv.style.right = '0';
};
Tiny.defaultSettings.changeValueFunc = function (barWrapperDiv, barDiv, value) {
    barDiv.style.left = (100 - value) + '%';
};
//let tinyProgress2 = new TinyProgress.TinyBar() //'top-test'
//tinyProgress2.start(true)
var tinyProgress = new Tiny.TinyBar('top-test', {
    backgroundColor: 'red',
}); //'top-test'
/*
setTimeout(() => {
